...
> 本工作区新增的 **Nebulaw-Ontology Pilot Demo**：运行 `pnpm demo:plus`，打开 `http://127.0.0.1:4183`。完整安装、演示、真实模型/学习边界与验证证据见 [中文交接文档](PALANTIR_PLUS_HANDOFF.md)。以下保留上游 Open Foundry 项目说明。
