...
The research was developed as a sequence of registered experiments. Each step
records what was tested, what failed or remained uncertain, and why the next
step changed the learning or governance design. The public interpretation is
about **active learning of ontology Logic**: updating a bounded belief about
rules, evidence, state, and permitted actions, then validating a candidate
change before it becomes stable Logic.

| Stage | Question | Current reading |
| --- | --- | --- |
| P10–P18 | Can rule explanations, definitions, and transitions be represented and recovered? | Representation and identifiability constraints were exposed; typed and compositional definitions became necessary. |
| P19–P35 | Can a structured belief state support planning, probing, and multi-step evaluation? | Strong finite statistical methods remained essential; several neural or unconstrained routes did not establish extra value. |
| P36–P40 | Can learned behavior be made stable and fairly compared with strong kernels? | Optimization and seed checks were separated from the scientific claim; the strongest finite statistical kernel remained the reference. |
| P41–P56 | Can the system adapt to interactions, missingness, shifts, and longer feedback histories? | Adaptation mechanisms were tested independently; negative and unresolved cases were retained instead of folded into one score. |
| P57–P60 | Does selecting observations and acting again after feedback improve decisions? | Statistical active observation and two-step feedback passed their registered finite-world confirmation gates; this does not establish real-world legal effectiveness. |

See the concise [experiment ledger](docs/EXPERIMENT_LEDGER.md) and the
[artifact index](docs/ARTIFACT_INDEX.md) for the experiment-by-experiment
record, code entry points, reports, and result summaries.
